...
const ModalAddDepartment = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/controllers/developers/settings/department/department.php?id=${itemEdit.department_aid}` // update
          : `${apiVersion}/controllers/developers/settings/department/department.php`, // create
        itemEdit ? "put" : "post",
        values,
      ),
    onSuccess: (data) => {
